const quizData = {
    ...
    tamil: [
  { question: "'அன்பு' எனும் வார்த்தையின் அர்த்தம்?", options: ["வெறுப்பு", "பாசம்", "கோபம்", "தீமை"], correct: "பாசம்" },
                { question: "'சாதி' எனும் வார்த்தையின் அர்த்தம்?", options: ["மக்கள் பிரிவு", "மழை", "நதி", "பூ"], correct: "மக்கள் பிரிவு" },
                { question: "'மகிழ்ச்சி' எனும் வார்த்தையின் அர்த்தம்?", options: ["கோபம்", "இன்பம்", "அழுகை", "சோர்வு"], correct: "இன்பம்" },
                { question: "'நட்பு' என்பதன் பொருள்?", options: ["சண்டை", "நண்பர்", "வெறுப்பு", "பயம்"], correct: "நண்பர்" },
                { question: "'கண்' என்பதன் பொருள்?", options: ["முகம்", "மூக்கு", "பார்வை", "வாய்"], correct: "பார்வை" },
                { question: "'சூரியன்' என்பதன் பொருள்?", options: ["நிலா", "வெயில்", "மழை", "பூ"], correct: "வெயில்" },
                { question: "'வானம்' என்பதன் பொருள்?", options: ["கடல்", "நிலம்", "ஆகாயம்", "மரம்"], correct: "ஆகாயம்" },
                { question: "'நிலா' என்பதன் பொருள்?", options: ["சூரியன்", "மதி", "காற்று", "நதி"], correct: "மதி" },
                { question: "'மழை' என்பதன் பொருள்?", options: ["தண்ணீர் பொழிவு ", "காற்று", "பூ", "மரம்"], correct: "தண்ணீர் பொழிவு" },
                { question: "'மரம்' என்பதன் பொருள்?", options: ["பெரிய செடி", "காற்று", "மழை", "பூ"], correct: "பெரிய செடி" },
                { question: "'காற்று' என்பதன் பொருள்?", options: ["நதி", "மூச்சு", "மழை", "மரம்"], correct: "மூச்சு" },
                { question: "'பறவை' என்பதன் பொருள்?", options: ["மிருகம்", "முட்டை", "விலங்கு", "மரம்"], correct: "விலங்கு" },
                { question: "'நதி' என்பதன் பொருள்?", options: ["ஆறு", "காடு", "மழை", "மரம்"], correct: "ஆறு" },
                { question: "'பூ' என்பதன் பொருள்?", options: ["மரம்", "காற்று", " மலர்", "மழை"], correct: " மலர்" },
                { question: "'கடல்' என்பதன் பொருள்?", options: ["பெருங்கடல்", "மழை", "காற்று", "நதி"], correct: "பெருங்கடல்" },
                { question: "'நிலம்' என்பதன் பொருள்?", options: ["மரம்", "மண்", "காற்று", "மழை"], correct: "மண்" },
                { question: "'மிருகம்' என்பதன் பொருள்?", options: ["விலங்கு", "பறவை", "மரம்", "மழை"], correct: "விலங்கு" },
                { question: "'புது' என்பதன் பொருள்?", options: ["பழைய", "புதியது", "நீளமான", "குடி"], correct: "புதியது" },
                { question: "'அழகு' என்பதன் பொருள்?", options: ["கோழை", "இனிமை", "தூசி", "சிவப்பு"], correct: "இனிமை" },
                { question: "'வசந்தம்' என்பதன் பொருள்?", options: ["பசுமை", "குளிர்", " பகவத்காலம்", "வெயில்"], correct: " பகவத்காலம்" },
                { question: "'குடும்பம்' என்பதன் பொருள்?", options: ["நண்பர்கள்", "உறவினர்", "பள்ளி", "மரம்"], correct: "உறவினர்" },
                { question: "'கை' என்பதன் பொருள்?", options: [" உறுப்பு", "கால்", "முகம்", "வாய்"], correct: " உறுப்பு" },
                { question: "'பரிவு' என்பதன் பொருள்?", options: ["நட்பு", "அன்பு", "சண்டை", "அழுகை"], correct: "அன்பு" },
                { question: "'அச்சம்' என்பதன் பொருள்?", options: ["அன்பு", " பயம்", "வெறுப்பு", "சிலர்"], correct: "பயம்" },
                { question: "'நலம்' என்பதன் பொருள்?", options: ["சுகாதாரம்", "நோய்", "தொல்லை", "சோர்வு"], correct: "சுகாதாரம்" },
                { question: "'சாந்தி' என்பதன் பொருள்?", options: ["சந்தோஷம்", "அமைதி", "சண்டை", "மகிழ்ச்சி"], correct: "அமைதி" },
                { question: "'வீடு' என்பதன் பொருள்?", options: ["இல்லம்", "பள்ளி", "வணிகம்", "அருகம்"], correct: "இல்லம்" },
                { question: "'படிப்பு' என்பதன் பொருள்?", options: ["பாடம்", "கற்றல்", "வேலை", "சந்தை"], correct: "கற்றல்" },
                { question: "'நேர்மை' என்பதன் பொருள்?", options: ["மொழி", "சத்தியம்", "குற்றம்", "வெறுப்பு"], correct: "சத்தியம்" },
                { question: "'பெருமை' என்பதன் பொருள்?", options: ["அழுகை", "மெச்சம்", "தாழ்வு", "கோபம்"], correct: "மெச்சம்" },
                { question: "'அம்சம்' என்பதன் பொருள்?", options: ["மதிப்பு", "குறிப்பு", "இலட்சணம்", "பொருள்"], correct: "இலட்சணம்" },
                { question: "'வானொலி' என்பதன் பொருள்?", options: ["பயணம்", "செய்தி", "ரேடியோ", "வழக்கு"], correct: "ரேடியோ" },
                { question: "'பக்கம்' என்பதன் பொருள்?", options: ["அருகில்", "வெளியில்", "பக்கம்", "வெளி"], correct: "அருகில்" },
                { question: "'துணை' என்பதன் பொருள்?", options: ["உதவி", "துணை", "தொல்லை", "வாழ்வு"], correct: "உதவி" },
                { question: "'பூச்சி' என்பதன் பொருள்?", options: ["மரம்", "வண்டு", "சிறிய உயிரினம்", "மழை"], correct: "சிறிய உயிரினம்" },
                { question: "'சவால்' என்பதன் பொருள்?", options: ["சண்டை", "போராட்டம்", "வெற்றி", "தோல்வி"], correct: "போராட்டம்" },
                { question: "'அருகில்' என்பதன் பொருள்?", options: ["வெளியில்", "பக்கத்தில்", "சிலர்", "கொசு"], correct: "பக்கத்தில்" },
                { question: "'வண்ணம்' என்பதன் பொருள்?", options: ["நிறம்", "ஒளி", "தோற்றம்", "அழகு"], correct: "தோற்றம்" },
                { question: "'மதிப்பு' என்பதன் பொருள்?", options: ["தாழ்வு", "மரியாதை", "அமைதி", "சமாதானம்"], correct: "மரியாதை" },
